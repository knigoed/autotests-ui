...
with sync_playwright() as playwright:
    ...
    there_is_no_results_header = page.get_by_test_id('courses-list-empty-view-title-text')
    ...
    results_will_be_displayed_here_header = page.get_by_test_id('courses-list-empty-view-description-text')
    expect(results_will_be_displayed_here_header).to_be_visible()
    expect(results_will_be_displayed_here_header).to_have_text('Results from the load test pipeline will be displayed here')
